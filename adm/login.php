...
<body id="home">
		<div class="rain">
			<div class="border start">
            	<div id="validacoes_login"></div>
                <div id="box_form">
					<label for="email">Login</label>
					<input  id="cmp_login" name="email" type="text" placeholder="Login"/>
					<label for="pass">Senha</label>
					<input name="pass" id="cmp_senha" type="password" placeholder="Senha"/>
                    <button onClick="efetuar_login();" style="cursor:pointer"/>LOG IN</button>
				</div>
			</div>
		</div>
	</body>
